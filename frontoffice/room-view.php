...
checkPageBySupperAdmin('pms','Room View', 'Room View');
                    ...
                    <div class="card mb-4 reservationNav">
                        <div class="card-body">
                            <div class="dFlex jcsb">
                                ...
                                <div class="right">
                                    <ul>
                                        <li><a href="javascript:void(0)" id="addReservationBtn" data-page="roomView"> <i
