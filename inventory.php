...
checkPageBySupperAdmin('webBilder','Inventory', 'Inventory');
...
<body class="g-sidenav-show  bg-gray-100">
                    ...
                    <div class="col-auto my-auto">
                        <div class="h-100">
                            ...
                            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                                ...
                                <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Inventory
                                </li>
                            </ol>
                        </div>
                    </div>
   ...
   function loadInventory(){
       var action = $('#datepicker').val();
        ...
        $.ajax({
            url: '<?php echo FRONT_SITE ?>/include/ajax/inventory.php',
            type: 'post',
