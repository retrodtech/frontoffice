                        ...
                        if(mysqli_num_rows($detail_sql)>0){
                            while($detail_row= mysqli_fetch_assoc($detail_sql)){ 
                                ...
                                <ul class="roomAddContent">
                                    ...
                                    <li>
                                        <b>Rs <?php echo getRoomPriceById($detail_row['id'], $checkIn) ?></b> <br/>
                                        <span>per room / <br/> night Excluding <br/> GST</span>
                                    </li>
                                    <li>
                                    <?php
                                            
                                            if(roomExist($room_id,$_SESSION['checkIn'],$_SESSION['checkout'],$detail_row['id']) > 0){
                                                echo "<a  class='btn btn-lg add_guest_btn primary_btn' data-id='{$detail_row['id']}' data-room=' $room_id '>Book Room</a>";
                                            }else{
                                                echo "<a class='btn btn-danger '>Not Available</a>";
                                            }
