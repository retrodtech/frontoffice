        ...
        <div class="container">
            ...
            <div class="row" id="load_search">
                ...
                <?php
                    ...
                    $sql = mysqli_query($conDB, "select room.*,roomratetype.id as rdid from room,roomratetype where  room.id=roomratetype.room_id group by(room.id) ORDER BY `roomratetype`.`price` asc");
