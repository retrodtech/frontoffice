...
if($type == 'showPopUpGuestDetail'){
    ...
    if($maxAdult > $bookGuest){
        $addGouestBtn = '<div class="s25"></div><button id="addGustBtn" data-reservationtab='.$rTab.' data-bookingId = "'.$bid.'" data-roomNum = "'.$room_number.'" class="btn btn-outline-primary">Add Guest</button>';
    }
...
if($type == 'checkRoomCheckIn'){
    ...
    if($checkInStatus == 1){
        $sql = "update bookingdetail set checkinstatus = '2' where room_number = '$roomNum' and bid = '$rBID'";
        $data = [
            'msg'=> 'checkin',
            'status'=> '1'
        ];
    ...
    if($checkInStatus == 2){
        $sql = "update bookingdetail set checkinstatus = '3' where room_number = '$roomNum' and bid = '$rBID'";
        $data = [
            'msg'=> 'checkout',
            'status'=> '1'
        ];
...
if($type == 'checkInOutBtnClickFormSubmit'){
    ...
    $sql = "update booking set checkIn = '$checkIn', checkOut ='$checkOut' where id = '$rbi'";
