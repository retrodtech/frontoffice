...
if($type == 'showPopUpGuestDetail'){
    ...
    if($checkInStatus == 2){
        ...
        $btnGroupHtml = '
            ...
            <div class="btnGroup">
            <button data-reservationtab='.$rTab.' data-bookingId='.$bid.' data-roomnum="'.$roomNum.'" data-bdid="'.$bdid.'" class="btn  btn2 btn-primary" id="reservations"><i class="fas fa-print"></i> Edit Reservation</button>
    ...
    if($checkInStatus == 3){
        $btnGroupHtml = '
            <div class="btnGroup">
            <button data-reservationtab='.$rTab.' data-bookingId='.$bid.' data-roomnum="'.$roomNum.'" data-bdid="'.$bdid.'" class="btn  btn2 btn-primary" id="reservations"><i class="fas fa-print"></i> View Reservation</button>
    ...
    $html = '
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        <div class="card-header" style="height:'.$cardHeight.'%">
                            <div class="booking">
...
if($type == 'checkRoomCheckIn'){
    ...
    $guestEmailId = getGuestEmailId($guestId);
    // pr($_POST);
    if($checkInStatus == 1){
    ...
    if(mysqli_query($conDB,$sql)){
        send_email($guestEmailId, '','','',$msg,'Thank You.');
        echo json_encode($data);
    }else{
        echo json_encode($data);
    }
