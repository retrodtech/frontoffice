    ...
    <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="topNavBar">
        <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <ul class="navbar-nav  justify-content-end quickLink">
                <li class="nav-item d-flex align-items-center px-3" data-bs-toggle="tooltip" data-bs-placement="left" title="Hotel">
                    <a href="<?php echo FRONT_ADMIN_SITE ?>manage-hotel.php" class="nav-link text-body font-weight-bold px-0">
        ...
        <li class="nav-item d-flex align-items-center mr-2" data-bs-toggle="tooltip" data-bs-placement="left" title="Profile">
